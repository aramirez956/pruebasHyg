...
public class WebUtil {
	...
	public static void verificarSession(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		if (session.getAttribute("usuario") != null) {
			...
			response.sendRedirect("/MapGIS/index.html");
		}
	}
	...
	public static String decodeBase64(String cadenaCodificada) {
		try {
			...
			String decodedString = new String(decodedBytes).replace("||a||", "á").replace("||e||", "é").replace("||i||", "í").replace("||o||", "ó").replace("||u||", "ú").replace("||A||", "Á")
					.replace("||E||", "É").replace("||I||", "Í").replace("||O||", "Ó").replace("||U||", "Ú").replace("||n||", "ñ").replace("||N||", "Ñ").replace("||!||", "¡").replace("||?||", "¿")
	...
	public static String encodeBase64(String cadena) {
		try {
			...
			BASE64Decoder decoder = new BASE64Decoder();
			byte[] decodedBytes = decoder.decodeBuffer(cadena);
	...
	public static String colorToString(Color color) {
		System.out.printf("<span style=\"background:rgb(%d,%d,%d)\">%s</span>%n", color.getRed(), color.getGreen(), color.getBlue(), color);
	...
	public static String replacePalabraClaves(String texto) {
		texto.toUpperCase().replaceAll("ACCESS", "").replaceAll("ACCOUNT", "").replaceAll("ACTIVATE", "").replaceAll("ADD", "").replaceAll("ADVISE", "").replaceAll("AFTER", "")
				.replaceAll("ALL_ROWS", "").replaceAll("ALLOCATE", "").replaceAll("ALTER", "").replaceAll("ANALYZE", "").replaceAll("ANY", "").replaceAll("ARCHIVE", "").replaceAll("ARCHIVELOG", "")
				.replaceAll("ARRAY", "").replaceAll("AUTHENTICATED", "").replaceAll("AUTHORIZATION", "").replaceAll("AUTOEXTEND", "").replaceAll("AUTOMATIC", "").replaceAll("BACKUP", "")
				.replaceAll("BECOME", "").replaceAll("BEFORE", "").replaceAll("BEGIN", "").replaceAll("BFILE", "").replaceAll("COLUMN", "").replaceAll("COLUMNS", "").replaceAll("CONSTRAINT", "")
				.replaceAll("EXECUTE IMMEDIATE", "").replaceAll("CURSOR", "").replaceAll("DROP", "").replaceAll("DECLARE", "").replaceAll("CYCLE", "").replaceAll("FROM", "").replaceAll("DANGLING", "")
				.replaceAll("WHERE", "").replaceAll("DELETE", "").replaceAll("UPDATE", "").replaceAll("SELECT", "").replaceAll("FROM", "").replaceAll("DUAL", "").replaceAll(";", "")
				.replaceAll(".", "").replaceAll("CREATE", "").replaceAll("DROP", "").replaceAll("ALTER", "").replaceAll("RENAME", "").replaceAll("TRUNCATE", "").replaceAll("TABLE", "")
				.replaceAll("VALUES", "").replaceAll("DATABASE", "").replaceAll("DEBUG", "").replaceAll("DISTINCT", "").replaceAll("EXECUTE", "").replaceAll("INSERT", "").replaceAll("PROCEDURE", "")
				.replaceAll("REPLACE", "").replaceAll("ROW", "").replaceAll("SELECT", "").replaceAll("SESSION", "").replaceAll("SPLIT", "").replaceAll("STRUCTURE", "").replaceAll("SYSDBA", "")
				.replaceAll("SYSOPER", "").replaceAll("SYSTEM", "").replaceAll("TABLE", "").replaceAll("TABLES", "").replaceAll("TABLESPACE", "").replaceAll("TRIGGERS", "").replaceAll("UPDATE", "")
				.replaceAll("VIEW", "").replaceAll("WITH", "").replaceAll("WHERE", "").replaceAll("CHR", "");
		return texto;
	}
